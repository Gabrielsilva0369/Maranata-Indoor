// Todos os países (ISO 3166-1 alpha-2). Os nomes são resolvidos em pt-BR pelo
// próprio navegador (Intl.DisplayNames), sem precisar de arquivo de dados.
const CODES = (
...
try { dn = new Intl.DisplayNames(['pt-BR'], { type: 'region' }) } catch { /* sem suporte */ }
